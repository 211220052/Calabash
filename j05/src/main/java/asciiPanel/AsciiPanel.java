...
public class AsciiPanel extends JPanel {
     ...
     * A brighter blue.
     */
    public static Color darkBlue = new Color (65, 105, 225);
    ...
    public static Color babyBlue = new Color(137, 207, 240);

    public static Color powderBlue = new Color(176, 224, 230);
    public static Color aquamarineBlue = new Color(0, 255, 255);
    ...
    //private String terminalFontFile = "pic/cp437_9x16.png";
    //private String terminalFontFile = "pic/taffer_10x10.png";
    //private String terminalFontFile = "pic/talryth_square_15x15.png";
